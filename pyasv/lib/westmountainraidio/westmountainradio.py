...
class west_mountain_radio():
    ...
    def set_circuit_on(self,circuit):
        if circuit is 0:
            data = dict(RAILENA0='1')
        elif circuit is 1:
            data = dict(RAILENA1='1')
        elif circuit is 2:
            data = dict(RAILENA2='1')
        elif circuit is 3:
            data = dict(RAILENA3='1')
        elif circuit is 4:
            data = dict(RAILENA4='1')
        r = requests.post(self.url,data)

    def set_circuit_off(self,circuit):
        if circuit is 0:
            data = dict(RAILENA0='0')
        elif circuit is 1:
            data = dict(RAILENA1='0')
        elif circuit is 2:
            data = dict(RAILENA2='0')
        elif circuit is 3:
            data = dict(RAILENA3='0')
        elif circuit is 4:
            data = dict(RAILENA4='0')
        r = requests.post(self.url,data)

    def set_all_circuits_on(self):
        data = dict(RAILENA0='1',RAILENA1='1',RAILENA2='1',RAILENA3='1',RAILENA4='1')
        r = requests.post(self.url,data)
    
    def set_all_circuits_off(self):
        data = dict(RAILENA0='0',RAILENA1='0',RAILENA2='0',RAILENA3='0',RAILENA4='0')
        r = requests.post(self.url,data)
